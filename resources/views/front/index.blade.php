...
@section('content')
    ...
    <body class="font-[Poppins] pb-[72px]">
        ...
        @forelse ($category_lists as $category_list)
            <section id="Latest-category" class="max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-[70px]">
                <div class="flex justify-between items-center">
                    <h2 class="font-bold text-[26px] leading-[39px]">
                        Latest For You <br />
                                ...
                                <div class="card-detail w-full flex items-end p-[30px] relative z-20">
                                    <div class="flex flex-col gap-[10px]">
                                        ...
                                        <a href="{{ route('front.details', $category_featured_list->slug) }}"
                                            class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">{{ $category_featured_list->name }}</a>
                                        <p class="text-white">
                                            {{ $category_featured_list->created_at->format('M d, Y') }}</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    @if ($category_article->category_id == $category_list->id)
                                        <a href="{{ route('front.details', $category_article->slug) }}"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="w-[130px] h-[100px] flex shrink-0 rounded-[20px] overflow-hidden">
